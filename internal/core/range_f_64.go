...
func NewRangeF64Null() RangeF64 {
	...
	bits := RangeF64Configs.Groups.B | RangeF64NullMask
...
func NewRangeF64Infinite(pIsPositive bool) RangeF64 {
	bits := RangeF64Configs.Groups.B | 0x0000000000000001
	if !pIsPositive {
		bits |= SignMask
	}
	return NewRangeF64FromU64(bits)
...
func NewRangeF64Percentage(pF64 float64) RangeF64 {
	...
	finalBits := RangeF64Configs.Groups.C | 0x0000000000000001 | valueBits
...
func NewRangeF64Identifier(sequenceType uint8, elementType uint8, elementID uint64) RangeF64 {
	...
	value := RangeF64Configs.Groups.D |
		uint64(sequenceType)<<SequenceTypeShift |
		uint64(elementType)<<ElementTypeShift |
		(elementID & ValueMask)
...
func (sF64 RangeF64) IsNullValue() bool {
	...
	return (bits & (GroupMask | SubgroupMask)) == RangeF64Configs.Groups.B
}

// Retorna cert només si el RangeF64 representa un error.
func (sF64 RangeF64) IsError() bool {
	bits := F64ToU64(sF64.value)
	return (bits & GroupMask) == RangeF64Configs.Groups.B
}
...
// func (sF64 RangeF64) IsInfinite() bool {
// 	return sF64.IsInfinitePos() || sF64.IsInfiniteNeg()
// }
...
// 	return value >= RangeF64Configs.TwoPi.Min && value <= RangeF64Configs.TwoPi.Max
// }
...
// 		return NewRangeF64(RangeF64Configs.TwoPi.Max)
// 	}
// 	if result < RangeF64Configs.TwoPi.Min {
// 		return NewRangeF64(RangeF64Configs.TwoPi.Min)
// 	}
...
// 	// Si el resultat supera els límits, retornem valor saturat
// 	if result > RangeF64Configs.TwoPi.Max {
// 		return NewRangeF64(RangeF64Configs.TwoPi.Max), nil
// 	}
// 	if result < RangeF64Configs.TwoPi.Min {
// 		return NewRangeF64(RangeF64Configs.TwoPi.Min), nil
// 	}
